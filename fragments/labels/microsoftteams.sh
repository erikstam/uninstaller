...
microsoftteams2)
      ...
      appFiles+=("<<Users>>/Library/Application Scripts/com.microsoft.teams2.agent")
      appFiles+=("<<Users>>/Library/Application Scripts/com.microsoft.teams2.notificationcenter")
      appFiles+=("<<Users>>/Library/Application Scripts/com.microsoft.teams2.respawn")
      appFiles+=("<<Users>>/Library/Group Containers/UBF8T346G9.com.microsoft.teams")
      appFiles+=("<<Users>>/Library/Group Containers/com.microsoft.teams2.widgetextension")

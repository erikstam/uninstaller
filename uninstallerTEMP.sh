...
uninstallApp() {
  ...
  case $1 in
    ...
    python3.7)
      appTitle="Python 3.7"
      appFiles+=("/Applications/Python 3.7")
      appFiles+=("/Library/Frameworks/Python.framework/Versions/3.7")
      ;;
    python3.8)
      appTitle="Python 3.8"
      appFiles+=("/Applications/Python 3.8")
      appFiles+=("/Library/Frameworks/Python.framework/Versions/3.8")
      ;;
    python3.10)
      appTitle="Python 3.10"
      appFiles+=("/Applications/Python 3.10")
      appFiles+=("/Library/Frameworks/Python.framework/Versions/3.10")
      ;;
    sketch)
      appTitle="Sketch"
